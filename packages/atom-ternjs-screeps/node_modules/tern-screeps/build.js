...
for(var i in resources) {
    def_screeps[i] = "string";
    resourceKeys[resources[i]] = "number";
}

var _docs = {
    transfer: {
        transfer: {
            "!doc": "Transfer resource from this structure to a creep. You can transfer resources to your creeps from hostile structures as well. The target has to be at adjacent square.\n\nArguments:\n* target - The target creep.\n* resourceType - One of the RESOURCE_* constants.\n* amount (optional) - The amount of resources to be transferred. If omitted, all the available amount is used.\n\nCPU cost: CONST",
            "!type": "fn(target: +Creep, resourceType: string, amount?: number) -> number"
        }
    },
    transferEnergy: {
        transferEnergy: {
            "!doc": "Transfer energy from this structure to a creep.\n\nArguments:\n* target - The target object.\n* amount (optional) - The amount of energy to be transferred. If omitted, all the available energy is used.\n\nCPU cost: CONST",
            "!type": "fn(target: object, amount: number) -> number"
        },
    },
    store: {
        store: _extend({
            "!doc": "An object with the storage contents. Each object key is one of the RESOURCE_* constants, values are resources amounts. RESOURCE_ENERGY is always defined and equals to 0 when empty, other resources are undefined when empty."
        }, resourceKeys),
        storeCapacity: {
            "!doc": "The total amount of resources the storage can contain.",
            "!type": "number"
        },
    },
    energy: {
        energy: {
            "!doc": "The amount of energy containing in the structure.",
            "!type": "number"
        },
        energyCapacity: {
            "!doc": "The total amount of energy the structure can contain.",
            "!type": "number"
        },
    }
}
...
_extend(def_screeps, {
    ...
    Creep: {
        ...
        prototype: _extend({}, def_screeps.RoomObject.prototype, {
            ...
            carry: _extend({
                "!doc": "An object with the creep's cargo contents. Each object key is one of the RESOURCE_* constants, values are resources amounts."
            }, resourceKeys),
            carryCapacity: {
                "!type": "number",
                "!doc": "The total amount of resources the creep can carry."
            },
            fatigue: {
                "!type": "number",
    ...
    StructureContainer: {
        ...
        prototype: _extend({}, _docs.store, _docs.transfer, def_screeps.Structure.prototype, {
            ticksToDecay: {
    ...
    StructureExtension: {
        ...
        prototype: _extend({}, _docs.energy, _docs.transferEnergy, def_screeps.OwnedStructure.prototype)
    },
    StructureExtractor: {
        "!type": "fn()",
    ...
    StructureLab: {
        ...
        prototype: _extend({}, _docs.energy, _docs.transfer, def_screeps.OwnedStructure.prototype, {
            cooldown: {
                "!doc": "The amount of game ticks the lab has to wait until the next reaction is possible.",
                "!type": "number"
            },
            mineralAmount: {
                "!doc": "The amount of minerals containing in the structure.",
                "!type": "number"
            },
            mineralType: {
            ...
            mineralCapacity: {
                "!doc": "The total amount of minerals the structure can contain.",
                "!type": "number"
            },
            boostCreep: {
    ...
    StructureLink: {
        ...
        prototype: _extend({}, _docs.energy, def_screeps.OwnedStructure.prototype, {
            cooldown: {
    ...
    StructureStorage: {
        ...
        prototype: _extend({}, _docs.store, _docs.transfer, def_screeps.OwnedStructure.prototype)
    },
    StructureTerminal: {
        "!type": "fn()",
    ...
    StructureTower: {
        ...
        prototype: _extend({}, _docs.transferEnergy, _docs.energy, def_screeps.OwnedStructure.prototype, {
            attack: {
    ...
    StructureNuker: {
        ...
        prototype: _extend({}, _docs.energy, def_screeps.OwnedStructure.prototype, {
            ...
            ghodium: {
                "!doc": "The amount of ghodium containing in the structure.",
                "!type": "number"
            },
            ghodiumCapacity: {
                "!doc": "The total amount of ghodium the structure can contain.",
                "!type": "number"
            },
            cooldown: {
    ...
    Room: {
        ...
        prototype: {
            ...
            findPath: {
                ...
                "!type": "fn(fromPos: +RoomPosition, toPos: +RoomPosition, opts?: object) -> Path"
            },
            getPositionAt: {
